...
and/or your read books, colour coded by decade.
"""
...
if __name__ == '__main__':
    args = parse_args('Render a graphical representation of your to-be-read pile '
                      'aka Mount Tsundoku, colour coded by decade',
                      'cdf')

    col_cfg = args.colour_cfg.select_category('decades')
    t = Tsundoku(col_cfg, 'decade')
