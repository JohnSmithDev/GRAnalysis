#!/usr/bin/env python3
"""
Show average ranking of publication years, with a bar chart breaking down the rankings
"""
...
if __name__ == '__main__':
    args = parse_args('Show average rating of publication years, with a bar chart breaking down the rankings',
                      'f')
